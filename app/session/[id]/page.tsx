...
export default function SessionPage() {
  ...
  setFileError(`These files are too large (max 300MB): ${names}`)
            ...
            <Card className="neubrutalism-card bg-yellow-300">
              ...
              <CardContent>
                ...
                >
                  ...
                  <p className="text-xs md:text-sm font-bold mt-4 text-gray-600">{'Max 300MB per file • Multi-file support • Transfer with Encryption • AI based Checking'}</p>
                </div>
              </CardContent>
            </Card>
          </div>
